...
<?php endif; ?>
 <form method="POST" action="<?php echo e(route('register')); ?>"class="m-0 p-0">
        <?php echo csrf_field(); ?>
<!-- component -->
<div class="min-h-screen bg-white bg-center flex items-center justify-center sm:py-12"
style="background-image: url('<?php echo e(asset('https://media.istockphoto.com/id/1293195643/vector/vector-illustration-of-a-red-car-moving-along-the-ocean-mountain-road.jpg?s=612x612&w=0&k=20&c=VsoxZBmqnNemBLxz_F7gSWZc7_lWzpiuxFa1xOUN9d8=')); ?>'); background-size: cover; background-position: center center;">
      ...
      <div class="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
        <div class="px-5 py-7">
            <div class="flex justify-center mb-5">
                <img src="<?php echo e(asset('https://api.logo.com/api/v2/images?design=lg_0r6pA8HsfMxrpPfBOC&u=849384e708717b4269adfcf45ced7cec1120fe407e801856a593285bcc722300&width=500&height=400&margins=100&fit=contain&format=webp&quality=60&tightBounds=true')); ?>" alt="Your Logo" class="w-50 h-50">
            </div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => '']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php echo $__env->make('base.base2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projectWFD\resources\views/auth/register.blade.php ENDPATH**/ ?>