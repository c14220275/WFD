...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container my-4 mx-auto p-8 rounded border border-gray-200">
        ...
        <form action="<?php echo e(route('car.update', $car->car_id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="number_plate" id="number_plate"
                           value="<?php echo e(old('number_plate', $car->number_plate)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="price" id="price"
                           value="<?php echo e(old('price', $car->price)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="no_rangka" id="no_rangka"
                           value="<?php echo e(old('no_rangka', $car->no_rangka)); ?>"
...
<?php echo $__env->make('base.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projectWFD\resources\views/cars/carEdit.blade.php ENDPATH**/ ?>